...
suppressWarnings(require(generics, quietly = TRUE))
suppressWarnings(require(tsibble, quietly = TRUE))
...
data <- tsibble(
  ...
  y     = sin(2*pi*(0:729)/7) + rnorm(730, 0, 0.2), # Sample data with weekly trend
  index = date
)
